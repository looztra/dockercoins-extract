...
redis = Redis(host="marathon-lb-internal.marathon.mesos", port="10001")


def get_random_bytes():
    r = requests.get("http://marathon-lb-internal.marathon.mesos:10002/32")
    return r.content


def hash_bytes(data):
    r = requests.post("http://marathon-lb-internal.marathon.mesos:10003/",
                      data=data,
